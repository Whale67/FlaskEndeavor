...
app.config.from_envar('DEBUG')
app.config.from_envar('CSRF_ENABLED')
app.config.from_envar('SECRET_KEY')
app.config.from_envar('FROM_EMAIL')
app.config.from_envar('FROM_PASSWORD')
app.config.from_envar('TO_EMAIL')
